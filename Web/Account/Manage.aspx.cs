...
{
    public partial class Manage : UIControls.InvestAppPage
    {
        ...
        protected void Page_Load()
        {
            if (!IsPostBack)
            {
                ...
                if (message != null)
				{
                    ...
                    SuccessMessage =
                        message == "ChangePwdSuccess" ? "Lozinka je uspješno promijenjena."
                        : message == "SetPwdSuccess" ? "Your password has been set."
                        : message == "RemoveLoginSuccess" ? "The external login was removed."
                        : String.Empty;

                    successMessage.Visible = !String.IsNullOrEmpty(SuccessMessage);
					passwordInfo.Visible = !successMessage.Visible;
                }
            }
