<%@ Page Title="" Language="C#" MasterPageFile="~/InvestMainContent.Master" AutoEventWireup="true" CodeBehind="FondKorisnikDetalji.aspx.cs" Inherits="InvestApp.Web.FondKorisnikDetalji" %>

<asp:Content ID="ContentHead" ContentPlaceHolderID="HeadContent" runat="server">

    <script src="/includes/jquery-1.11.0.min.js"></script>
    <script src="../includes/thickbox.js"></script>
    <link href="../includes/thickbox.css" rel="stylesheet" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1 class="form_header">Podaci korisnika</h1>

    <asp:FormView ID="FormViewKorisnik" runat="server" DataKeyNames="ID" DataSourceID="EntityDataSourceKorisnikDodatno" OnItemCommand="FormViewKorisnik_ItemCommand" RenderOuterTable="false" OnModeChanged="FormViewKorisnik_ModeChanged" OnDataBound="FormViewKorisnik_DataBound" OnModeChanging="FormViewKorisnik_ModeChanging">
        <EditItemTemplate>
            ...
            <div class="edit">
                ...
                <div class="form_item">
                    <label class="form_item_label_edit" for="ddlBanke">Broj računa:</label>
                    <asp:TextBox ID="VBDITextBox" placeholder="VBDI" CssClass="form_item_value_edit" runat="server" ClientIDMode="Static" Text='<%# Bind("RACUN_VBDI") %>' Width="56px" />
                    <asp:TextBox ID="RACUN_BROJTextBox" placeholder="Broj računa" ClientIDMode="Static" CssClass="form_item_value_edit" runat="server" Text='<%# Bind("RACUN_BROJ") %>' Width="314px" />
                </div>
                ...
                <div class="form_item">
                    ...
                    <br />
                    <a class="image_link thickbox" href='<%# Bind("SLIKA_OSOBNE_URL") %>' runat="server" id="lightboxSLIKA_OSOBNE">
                ...
                <div class="form_item">
                    ...
                    <br />
                    <a class="image_link thickbox" href='<%# Bind("KARTICA_RACUNA_URL") %>' runat="server" id="lightboxKARTICA_RACUNA">
        ...
        <ItemTemplate>
            ...
            <div class="readonly">
                ...
                <div class="left">
                    ...
                    <div class="form_item">
                        <label class="form_item_label" for="ddlBanke">Broj računa:</label>
                        <asp:Label ID="VBDITextBox" placeholder="VBDI" CssClass="form_item_value" runat="server" ClientIDMode="Static" Text='<%# Bind("RACUN_VBDI") %>' />
                        <asp:Label ID="RACUN_BROJTextBox" placeholder="Broj računa" ClientIDMode="Static" CssClass="form_item_value" runat="server" Text='<%# Bind("RACUN_BROJ") %>' />
                    </div>
    ...
    <asp:EntityDataSource ID="EntityDataSourceKorisnikDodatno" runat="server" ConnectionString="name=FondEntities" DefaultContainerName="FondEntities" EnableFlattening="False" EnableUpdate="True" EntitySetName="Korisnici" EntityTypeFilter="Korisnik" AutoGenerateWhereClause="True" >
